...
def test_value_str() -> None:
    ...
    assert SampleModel(value="1").value == 1.0
...
def test_value_bool() -> None:
    assert SampleModel(value=True).value == 1.0
    assert SampleModel(value=False).value == 0.0
...
def test_value_bytes() -> None:
    ...
    assert SampleModel(value=b"1").value == 1.0
